    ...
    return (
      <div className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">아직 장바구니에 담긴 상품이 없습니다.</p>
          <Link href="/search">
    ...
    <div className="py-4 sm:py-8">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-4 sm:mb-8">
          <h1 className="text-xl sm:text-3xl font-bold text-gray-900">장바구니</h1>
          <button
            onClick={clearCart}
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-8">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              {items.map((item, index) => {
                ...
                return (
                  <div
                    key={itemKey}
                    className={`p-3 sm:p-6 ${index !== items.length - 1 ? 'border-b border-gray-100' : ''}`}
                  >
                    <div className="flex gap-3 sm:gap-6">
                      <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 rounded-lg overflow-hidden bg-gray-100 shrink-0">
                        <Image
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between gap-2">
                          <div className="min-w-0 flex-1">
                            {brand && (
                              <p className="text-xs sm:text-sm text-indigo-600 font-medium mb-0.5 sm:mb-1">
                                {brand.name}
                              </p>
                            )}
                            <h3 className="text-sm sm:text-lg font-semibold text-gray-900 mb-0.5 sm:mb-1 line-clamp-2">
                              {item.product.name}
                            </h3>
                            {item.variant && (
                          ...
                          <div className="flex flex-col gap-1">
                            <div className="flex items-center border border-gray-200 rounded-lg">
                              <button
                                ...
                                className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center text-gray-600 hover:bg-gray-50"
                              >
            ...
            <div className="mt-4 sm:mt-6">
              <Link
                href="/search"
                className="inline-flex items-center text-sm sm:text-base text-indigo-600 font-medium hover:underline"
              >
          ...
          <div className="lg:col-span-4 mt-6 lg:mt-0">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 sticky top-24">
              ...
              <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                ...
                <div className="border-t border-gray-200 pt-2 sm:pt-3 flex justify-between font-semibold text-sm sm:text-base text-gray-900">
                  <span>총 금액</span>
